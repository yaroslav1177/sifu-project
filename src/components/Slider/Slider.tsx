          ...
          <div className="slide1">
            <div className="slide1__content">
              ...
              <p className="slide1__subtitle">
                The hunt for the assassins of your family will take you through
                the hidden corners of the city, from gang-ridden suburbs to the
                cold hallways of corporate towers. You have one day, and
                countless enemies on your way. Time will be the price to pay.
              </p>
            </div>
          </div>
        </SwiperSlide>
          ...
          <div className="slide2">
            <div className="slide2__content">
              ...
              <p className="slide2__subtitle">
                ...
                advantage are key to your survival. Throwable objects, makeshift
                weapons, windows and ledges... The odds are stacked against you,
                you will have to use everything at your disposal to prevail.
              </p>
            </div>
          </div>
        </SwiperSlide>
