...
const translations: LanguageTranslations = {
  ...
  ua: {
    ...
    slideOneDescription:
      "Полювання на вбивць вашої сім'ї проведе вас через таємні куточки міста, від охоплених бандами передмість до холодних коридорів корпоративних веж. У вас один день і незліченна кількість ворогів на вашому шляху. Час буде ціною.",
    slideTwoDescription:
      "Ретельне розміщення та розумне використання навколишнього середовища на вашу користь є ключовими для вашого виживання. Кидальні предмети, саморобна зброя, вікна та виступи... Шанси проти вас, вам доведеться використовувати все, що є у вашому розпорядженні, щоб перемогти.",
    slideThreeDescription:
      "Кунг-фу - це шлях для тіла і розуму. Вчіться на своїх помилках, відкрийте унікальні навички та знайдіть у собі сили, щоб освоїти нищівні прийоми Пак-Мей Кунг-Фу.",
    newsTitle: "ОСТАННІ НОВИНИ",
    arenasTitle: "ПАТЧ 1.19 і 1.20 - АРЕНИ ТА ПАТЧ ПЕРШОГО ДНЯ",
    arenasDate: "28 березня, 2023",
    arenasDescription:
      "Sifu нарешті в Steam і Xbox, а також оновлення Arenas тут!",
